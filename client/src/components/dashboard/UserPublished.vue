<template>
  <div class="col-10 bg-light" style="height: 95vh;" id="overflow" v-if="currentPage === 'dashboardPublished'">
            
    <h3 class="mt-4 text-coffee">Published</h3>
...
export default {
  ...
  methods: {
    ...
    changeArticles(articles) {
      console.log(articles, 'dari userpublished')
