<template>
  <div class="col-10 bg-light" style="height: 95vh;" id="overflow" v-if="currentPage === 'dashboardUnpublished'">
              
    <h3 class="mt-4 text-coffee">Don't forget to publish the article when it's ready.</h3>
...
export default {
  name: "UserUnpublished",
  props: {
    formatedArticles: Array,
    notification: String,
    currentPage: String
  },
  components: {
